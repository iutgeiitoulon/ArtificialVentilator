...
namespace MessageGenerator
{
    public class MsgGenerator
    {
        ...
        public void GenerateMessageResetLearning(object sender, UnsupervisedLearningParametersArgs e)
        {
            byte[] payload = new byte[2];

            OnMessageToRespirator((Int16)Commands.ResetLearning, 2, payload);
        }
